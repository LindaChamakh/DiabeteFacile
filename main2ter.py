...
def miseAJourFichierTexte(simuli,glycemieNuit,chemin,moment):
        r=0
...
class fenetre2(QtGui.QDialog):
        ...
        def traitementDecision(self,cC):
                ...
                for i in range(3):
                        self.simuli.courant.append({0:[0,0]})
                ...
                miseAJourFichierTexte(self.simuli,self.glycemieNuitValue,self.databaseInitialChemin)
